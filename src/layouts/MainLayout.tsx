    ...
    <>
      <header className="h-16 bg-slate-800">
        <div className="container mx-auto h-full flex justify-between items-center text-white font-bold text-2xl">
          ...
          <nav>
            <ul>
              <li className="text-base flex gap-1 cursor-pointer items-center transition-all ease-in-out hover:text-purple-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
      ...
      <footer className="h-16 bg-slate-800 ">
        <div className="container mx-auto h-full flex justify-between items-center text-white text-md font-medium">
          <a
            ...
            target="_blank"
            className="flex gap-1 transition-all ease-in-out hover:text-purple-500"
            rel="noreferrer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span>Created by Reznichenko</span>
        </div>
      </footer>
    </>
  );
