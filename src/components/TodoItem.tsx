        ...
        <div className="flex justify-between gap-4 text-slate-400 flex-wrap">
          <div className="flex gap-4 items-end flex-1">
            <div className="flex gap-1">
              ...
              {formatDateString(todo.createdAt)}
            </div>
            <div className="flex gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <button className="flex items-center gap-1 border-2 px-2 py-1 rounded-lg border-purple-500 text-purple-500 hover:bg-purple-500 transition-all ease-in-out hover:text-slate-50">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
